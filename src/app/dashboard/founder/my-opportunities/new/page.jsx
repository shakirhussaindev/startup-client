...
export default function AddOpportunityPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // 2. Mock startup information (ready to be replaced with DB fetch later)
      const startup = {
        startupId: "start012",
        name: "StartupForge Labs",
        logo: "https://api.dicebear.com/7.x/identicon/svg?seed=StartupForge",
